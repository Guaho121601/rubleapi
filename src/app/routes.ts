  ...
  const createGeneratorPage = async (
    ...
    const pageConfig =
      mode === "converter"
        ...
        : {
            PAGE_PATH: "/widget",
            PAGE_TITLE: "Виджет или информер курсов валют для сайта | RubleAPI",
            META_DESCRIPTION:
              "Бесплатный виджет или информер курсов валют для сайта с данными ЦБ РФ. Выберите валюты, настройте оформление и вставьте готовый код на сайт.",
            BREADCRUMB_NAME: "Виджет или информер курсов валют",
            EYEBROW: "Виджет или информер курсов валют",
            HERO_TITLE: "Виджет или информер курсов валют для сайта",
            HERO_COPY:
              "Добавьте на сайт виджет или информер курсов валют по данным ЦБ РФ. Выберите валюты, настройте внешний вид, скопируйте код и вставьте готовый блок на сайт.",
            SETTINGS_TITLE: "Настройки виджета курсов",
            SETTINGS_COPY:
              "Отметьте нужные валюты, настройте оформление и сразу посмотрите, как виджет или информер курсов будет выглядеть на сайте.",
            CURRENCY_HINT:
            ...
            FOOTER_PRODUCT_COPY:
              "RubleAPI помогает быстро добавить на сайт виджет или информер курсов валют по данным ЦБ РФ.",
